...
| `leaderboard-density.spec.ts` | 四角色共同读取排行榜且逐 context 核对匿名或 username/role；三视口、无 SummaryStrip、长文本、公开排名/计分样本分区、全来源单槽队列、上下滚动、滚动中可操作的 Radix tabs、慢响应切游戏清旧列表、sticky 表头、无根横溢出与 Console/Network |
